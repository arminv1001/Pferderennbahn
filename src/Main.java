...
public class Main {
    public static void main(String[] args) throws Widerspruch, Systemfehler {
        ...
        a.anmeldenReitpaar(reitpaar);
        a.anmeldenReitpaar(reitpaar1);
        a.anmeldenReitpaar(reitpaar2);
        a.anmeldenReitpaar(reitpaar3);
        a.anmeldenReitpaar(reitpaar4);
        a.erstelleSpieplan();
        ...
        Zuschauer zuschauer4 = new Zuschauer( "Jörk", "Lörik", 22,50);
        ...
        System.out.println("Kontostand: " + zuschauer.getKontostand());
        a.getSieger();
        System.out.println(zuschauer.getKontostand());
        System.out.println(zuschauer1.getKontostand());
        System.out.println(zuschauer2.getKontostand());
        System.out.println(zuschauer3.getKontostand());
        System.out.println(zuschauer4.getKontostand());
        System.out.println(zuschauer5.getKontostand());

    }
}
//TODO Beleg löschen und WettListe